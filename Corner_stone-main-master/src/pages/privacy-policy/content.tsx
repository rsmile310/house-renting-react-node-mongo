...
const content = () => {
  return (
    <div>
      ...
      <h2>
        <Translate>Collecting and Using Your Personal Data</Translate>
      </h2>
      <p>
        <Translate>Our pledge</Translate>
      </p>
      <p>
        <Translate>
      ...
      <div style={{ width: "100%", background: "#6A6F77" }}>
        <h2>
          <Translate>Types of Data Collected Personal Data</Translate>
        </h2>
      </div>
      <p>
        <Translate>
      ...
      <p><Translate>Usage Data</Translate></p>
      <p>
      <Translate>Usage Data Usage Data is collected automatically when using the
        ...
        unique device identifiers and other diagnostic data.</Translate>
      </p>
      <div style={{ width: "100%", background: "#6A6F77" }}>
        <h2><Translate>Information from Third-Party Social Media Services</Translate></h2>
      </div>
      <p>
      <Translate>The Company allows you to create an account and log in to use the
        ...
        activities or your contact list associated with that account.</Translate>
      </p>
      <div style={{ width: "100%", background: "#6A6F77" }}>
        <h2><Translate>Tracking Technologies and Cookies</Translate></h2>
      </div>
      <p>
      <Translate>We use Cookies and similar tracking technologies to track the activity
        ...
        Cookies,our Service may use Cookies.</Translate>
      </p>
    </div>
  );
};
